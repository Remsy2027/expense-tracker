...
export const CATEGORIES = [
  ...
  },
  {
    ...
    subcategories: ['Fuel', 'Public Transport', 'Taxi/Ride Share', 'Parking', 'Vehicle Maintenance']
  },
  {
    id: 'shopping',
    name: 'Shopping',
  ...
  },
  {
    ...
    subcategories: ['Electricity', 'Water', 'Internet', 'Phone', 'Subscriptions', 'Insurance']
  },
  {
    id: 'entertainment',
    name: 'Entertainment',
    ...
    subcategories: ['Movies', 'Games', 'Sports', 'Hobbies', 'Events', 'Streaming']
  },
  {
    id: 'medical',
    name: 'Medical',
    ...
    subcategories: ['Doctor Visits', 'Medicine', 'Dental', 'Pharmacy', 'Health Insurance']
  },
  {
    id: 'education',
    name: 'Education',
...
export const BUDGET_CATEGORIES = [
  { name: 'Essential', percentage: 50, description: 'Needs like food, housing, utilities' },
  { name: 'Discretionary', percentage: 30, description: 'Wants like entertainment, shopping' },
  { name: 'Savings', percentage: 20, description: 'Emergency fund, investments, goals' }
];
